 ...
 * @generated from protobuf service vald.v1.Insert
 */
export class InsertClient extends grpc.Client implements IInsertClient {
    ...
    insert(input: Insert_Request, metadata: grpc.Metadata | grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Location) => void), options?: grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Location) => void), callback?: ((err: grpc.ServiceError | null, value?: Object_Location) => void)): grpc.ClientUnaryCall {
        const method = Insert.methods[0];
        return this.makeUnaryRequest<Insert_Request, Object_Location>(`/${Insert.typeName}/${method.name}`, (value: Insert_Request): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_Location => method.O.fromBinary(value, this._binaryOptions), input, (metadata as any), (options as any), (callback as any));
    }
    /**
     * A method to add new multiple vectors by bidirectional streaming.
     *
    ...
    streamInsert(metadata?: grpc.Metadata | grpc.CallOptions, options?: grpc.CallOptions): grpc.ClientDuplexStream<Insert_Request, Object_StreamLocation> {
        const method = Insert.methods[1];
        return this.makeBidiStreamRequest<Insert_Request, Object_StreamLocation>(`/${Insert.typeName}/${method.name}`, (value: Insert_Request): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_StreamLocation => method.O.fromBinary(value, this._binaryOptions), (metadata as any), options);
    }
    /**
     * A method to add new multiple vectors in a single request.
     *
    ...
    multiInsert(input: Insert_MultiRequest, metadata: grpc.Metadata | grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Locations) => void), options?: grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Locations) => void), callback?: ((err: grpc.ServiceError | null, value?: Object_Locations) => void)): grpc.ClientUnaryCall {
        const method = Insert.methods[2];
        return this.makeUnaryRequest<Insert_MultiRequest, Object_Locations>(`/${Insert.typeName}/${method.name}`, (value: Insert_MultiRequest): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_Locations => method.O.fromBinary(value, this._binaryOptions), input, (metadata as any), (options as any), (callback as any));
    }
}
