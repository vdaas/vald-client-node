...
function serialize_payload_Upsert_MultiRequest(arg) {
  if (!(arg instanceof vald_v1_payload_payload_pb.Upsert.MultiRequest)) {
    throw new Error('Expected argument of type payload.Upsert.MultiRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_payload_Upsert_MultiRequest(buffer_arg) {
  return vald_v1_payload_payload_pb.Upsert.MultiRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_payload_Upsert_Request(arg) {
  if (!(arg instanceof vald_v1_payload_payload_pb.Upsert.Request)) {
    throw new Error('Expected argument of type payload.Upsert.Request');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_payload_Upsert_Request(buffer_arg) {
...
var UpsertService = exports.UpsertService = {
  ...
  multiUpsert: {
    path: '/vald.Upsert/MultiUpsert',
    requestStream: false,
    responseStream: false,
    requestType: vald_v1_payload_payload_pb.Upsert.MultiRequest,
    responseType: vald_v1_payload_payload_pb.Object.Locations,
    requestSerialize: serialize_payload_Upsert_MultiRequest,
    requestDeserialize: deserialize_payload_Upsert_MultiRequest,
