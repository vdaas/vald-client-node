...
interface IRemoveService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  removeByTimestamp: grpc.MethodDefinition<vald_v1_payload_payload_pb.Remove.TimestampRequest, vald_v1_payload_payload_pb.Object.Locations>;
  streamRemove: grpc.MethodDefinition<vald_v1_payload_payload_pb.Remove.Request, vald_v1_payload_payload_pb.Object.StreamLocation>;
...
export class RemoveClient extends grpc.Client {
  ...
  removeByTimestamp(argument: vald_v1_payload_payload_pb.Remove.TimestampRequest, callback: grpc.requestCallback<vald_v1_payload_payload_pb.Object.Locations>): grpc.ClientUnaryCall;
  removeByTimestamp(argument: vald_v1_payload_payload_pb.Remove.TimestampRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<vald_v1_payload_payload_pb.Object.Locations>): grpc.ClientUnaryCall;
  removeByTimestamp(argument: vald_v1_payload_payload_pb.Remove.TimestampRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<vald_v1_payload_payload_pb.Object.Locations>): grpc.ClientUnaryCall;
  streamRemove(metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null): grpc.ClientDuplexStream<vald_v1_payload_payload_pb.Remove.Request, vald_v1_payload_payload_pb.Object.StreamLocation>;
  streamRemove(metadata?: grpc.Metadata | null, options?: grpc.CallOptions | null): grpc.ClientDuplexStream<vald_v1_payload_payload_pb.Remove.Request, vald_v1_payload_payload_pb.Object.StreamLocation>;
