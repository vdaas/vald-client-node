 ...
 * @generated from protobuf service vald.v1.Remove
 */
export class RemoveClient extends grpc.Client implements IRemoveClient {
    ...
    remove(input: Remove_Request, metadata: grpc.Metadata | grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Location) => void), options?: grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Location) => void), callback?: ((err: grpc.ServiceError | null, value?: Object_Location) => void)): grpc.ClientUnaryCall {
        const method = Remove.methods[0];
        return this.makeUnaryRequest<Remove_Request, Object_Location>(`/${Remove.typeName}/${method.name}`, (value: Remove_Request): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_Location => method.O.fromBinary(value, this._binaryOptions), input, (metadata as any), (options as any), (callback as any));
    }
    /**
     * A method to remove an indexed vector based on timestamp.
     *
    ...
    removeByTimestamp(input: Remove_TimestampRequest, metadata: grpc.Metadata | grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Locations) => void), options?: grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Locations) => void), callback?: ((err: grpc.ServiceError | null, value?: Object_Locations) => void)): grpc.ClientUnaryCall {
        const method = Remove.methods[1];
        return this.makeUnaryRequest<Remove_TimestampRequest, Object_Locations>(`/${Remove.typeName}/${method.name}`, (value: Remove_TimestampRequest): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_Locations => method.O.fromBinary(value, this._binaryOptions), input, (metadata as any), (options as any), (callback as any));
    }
    /**
     * A method to remove multiple indexed vectors by bidirectional streaming.
     *
    ...
    streamRemove(metadata?: grpc.Metadata | grpc.CallOptions, options?: grpc.CallOptions): grpc.ClientDuplexStream<Remove_Request, Object_StreamLocation> {
        const method = Remove.methods[2];
        return this.makeBidiStreamRequest<Remove_Request, Object_StreamLocation>(`/${Remove.typeName}/${method.name}`, (value: Remove_Request): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_StreamLocation => method.O.fromBinary(value, this._binaryOptions), (metadata as any), options);
    }
    /**
     * A method to remove multiple indexed vectors in a single request.
     *
