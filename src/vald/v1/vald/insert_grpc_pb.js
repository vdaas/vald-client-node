...
function serialize_payload_Insert_MultiRequest(arg) {
  if (!(arg instanceof vald_v1_payload_payload_pb.Insert.MultiRequest)) {
    throw new Error('Expected argument of type payload.Insert.MultiRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_payload_Insert_MultiRequest(buffer_arg) {
  return vald_v1_payload_payload_pb.Insert.MultiRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_payload_Insert_Request(arg) {
  if (!(arg instanceof vald_v1_payload_payload_pb.Insert.Request)) {
    throw new Error('Expected argument of type payload.Insert.Request');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_payload_Insert_Request(buffer_arg) {
...
var InsertService = exports.InsertService = {
  ...
  multiInsert: {
    path: '/vald.Insert/MultiInsert',
    requestStream: false,
    responseStream: false,
    requestType: vald_v1_payload_payload_pb.Insert.MultiRequest,
    responseType: vald_v1_payload_payload_pb.Object.Locations,
    requestSerialize: serialize_payload_Insert_MultiRequest,
    requestDeserialize: deserialize_payload_Insert_MultiRequest,
