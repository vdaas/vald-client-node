...
interface IInsertService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  streamInsert: grpc.MethodDefinition<vald_v1_payload_payload_pb.Insert.Request, vald_v1_payload_payload_pb.Object.Location>;
...
export class InsertClient extends grpc.Client {
  ...
  streamInsert(metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null): grpc.ClientDuplexStream<vald_v1_payload_payload_pb.Insert.Request, vald_v1_payload_payload_pb.Object.Location>;
  streamInsert(metadata?: grpc.Metadata | null, options?: grpc.CallOptions | null): grpc.ClientDuplexStream<vald_v1_payload_payload_pb.Insert.Request, vald_v1_payload_payload_pb.Object.Location>;
