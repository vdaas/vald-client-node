...
function serialize_payload_Object_Blob(arg) {
  if (!(arg instanceof vald_v1_payload_payload_pb.Object.Blob)) {
    throw new Error('Expected argument of type payload.Object.Blob');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_payload_Object_Blob(buffer_arg) {
...
function serialize_payload_Search_ObjectRequest(arg) {
  if (!(arg instanceof vald_v1_payload_payload_pb.Search.ObjectRequest)) {
    throw new Error('Expected argument of type payload.Search.ObjectRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_payload_Search_ObjectRequest(buffer_arg) {
...
var FilterService = exports.FilterService = {
  ...
  multiInsertObject: {
    path: '/filter.Filter/MultiInsertObject',
    requestStream: false,
    responseStream: false,
    requestType: vald_v1_payload_payload_pb.Object.Blob,
  ...
  updateObject: {
    path: '/filter.Filter/UpdateObject',
    requestStream: false,
    responseStream: false,
    requestType: vald_v1_payload_payload_pb.Object.Blob,
    responseType: vald_v1_payload_payload_pb.Object.Location,
  ...
  streamUpdateObject: {
    path: '/filter.Filter/StreamUpdateObject',
    requestStream: true,
    responseStream: true,
    requestType: vald_v1_payload_payload_pb.Object.Blob,
    responseType: vald_v1_payload_payload_pb.Object.Location,
  ...
  multiUpdateObject: {
    path: '/filter.Filter/MultiUpdateObject',
    requestStream: false,
    responseStream: false,
    requestType: vald_v1_payload_payload_pb.Object.Blob,
    responseType: vald_v1_payload_payload_pb.Object.Locations,
  ...
  upsertObject: {
    path: '/filter.Filter/UpsertObject',
    requestStream: false,
    responseStream: false,
    requestType: vald_v1_payload_payload_pb.Object.Blob,
    responseType: vald_v1_payload_payload_pb.Object.Location,
  ...
  streamUpsertObject: {
    path: '/filter.Filter/StreamUpsertObject',
    requestStream: true,
    responseStream: true,
    requestType: vald_v1_payload_payload_pb.Object.Blob,
    responseType: vald_v1_payload_payload_pb.Object.Location,
  ...
  multiUpsertObject: {
    path: '/filter.Filter/MultiUpsertObject',
    requestStream: false,
    responseStream: false,
    requestType: vald_v1_payload_payload_pb.Object.Blob,
    responseType: vald_v1_payload_payload_pb.Object.Locations,
