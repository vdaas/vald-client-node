 ...
 * @generated from protobuf service vald.v1.Object
 */
export class ObjectClient extends grpc.Client implements IObjectClient {
    ...
    exists(input: Object_ID, metadata: grpc.Metadata | grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_ID) => void), options?: grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_ID) => void), callback?: ((err: grpc.ServiceError | null, value?: Object_ID) => void)): grpc.ClientUnaryCall {
        const method = Object.methods[0];
        return this.makeUnaryRequest<Object_ID, Object_ID>(`/${Object.typeName}/${method.name}`, (value: Object_ID): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_ID => method.O.fromBinary(value, this._binaryOptions), input, (metadata as any), (options as any), (callback as any));
    }
    /**
     * A method to fetch a vector.
     *
    ...
    getObject(input: Object_VectorRequest, metadata: grpc.Metadata | grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Vector) => void), options?: grpc.CallOptions | ((err: grpc.ServiceError | null, value?: Object_Vector) => void), callback?: ((err: grpc.ServiceError | null, value?: Object_Vector) => void)): grpc.ClientUnaryCall {
        const method = Object.methods[1];
        return this.makeUnaryRequest<Object_VectorRequest, Object_Vector>(`/${Object.typeName}/${method.name}`, (value: Object_VectorRequest): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_Vector => method.O.fromBinary(value, this._binaryOptions), input, (metadata as any), (options as any), (callback as any));
    }
    /**
     * A method to fetch vectors by bidirectional streaming.
     *
    ...
    streamGetObject(metadata?: grpc.Metadata | grpc.CallOptions, options?: grpc.CallOptions): grpc.ClientDuplexStream<Object_VectorRequest, Object_StreamVector> {
        const method = Object.methods[2];
        return this.makeBidiStreamRequest<Object_VectorRequest, Object_StreamVector>(`/${Object.typeName}/${method.name}`, (value: Object_VectorRequest): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_StreamVector => method.O.fromBinary(value, this._binaryOptions), (metadata as any), options);
    }
    /**
     * A method to get all the vectors with server streaming
     *
    ...
    streamListObject(input: Object_List_Request, metadata?: grpc.Metadata | grpc.CallOptions, options?: grpc.CallOptions): grpc.ClientReadableStream<Object_List_Response> {
        const method = Object.methods[3];
        return this.makeServerStreamRequest<Object_List_Request, Object_List_Response>(`/${Object.typeName}/${method.name}`, (value: Object_List_Request): Buffer => Buffer.from(method.I.toBinary(value, this._binaryOptions)), (value: Buffer): Object_List_Response => method.O.fromBinary(value, this._binaryOptions), input, (metadata as any), options);
    }
}
