...
proto.payload.Search.Config.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    epsilon: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0),
...
proto.payload.Search.Response.prototype.addResults = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.payload.Object.Distance, opt_index);
};
