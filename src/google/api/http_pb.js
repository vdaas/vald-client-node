...
class Http$Type extends runtime_4.MessageType {
    constructor() {
        super("google.api.Http", [
            { no: 1, name: "rules", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.HttpRule },
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.fully_decode_reserved_expansion !== false)
            writer.tag(2, runtime_1.WireType.Varint).bool(message.fully_decode_reserved_expansion);
...
// @generated message type with reflection information, may provide speed optimized methods
class HttpRule$Type extends runtime_4.MessageType {
    constructor() {
        super("google.api.HttpRule", [
            ...
            { no: 11, name: "additional_bindings", kind: "message", localName: "additional_bindings", repeat: 2 /*RepeatType.UNPACKED*/, T: () => exports.HttpRule }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.api.HttpRule additional_bindings */ 11:
                    message.additional_bindings.push(exports.HttpRule.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        for (let i = 0; i < message.additional_bindings.length; i++)
            exports.HttpRule.internalBinaryWrite(message.additional_bindings[i], writer.tag(11, runtime_1.WireType.LengthDelimited).fork(), options).join();
        /* string response_body = 12; */
        if (message.response_body !== "")
            writer.tag(12, runtime_1.WireType.LengthDelimited).string(message.response_body);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class CustomHttpPattern$Type extends runtime_4.MessageType {
    constructor() {
