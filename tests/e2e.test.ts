...
describe("Tests for node client", () => {
  ...
  //       try {
  //         expect(err).toBeFalsy();
  //         expect(resp).toBeInstanceOf(payload.Object_Locations);
  //         done();
  //       } catch (e) {
  //         done(e);
  //       }
  ...
  //       try {
  //         expect(err).toBeFalsy();
  //         expect(resp).toBeInstanceOf(payload.Info_Index_Count);
  ...
  //       try {
  //         expect(err).toBeFalsy();
  //         expect(resp).toBeInstanceOf(payload.Object_ID);
  //         done();
  //       } catch (e) {
  //         done(e);
  //       }
  ...
  //       try {
  //         expect(err).toBeFalsy();
  //         expect(resp).toBeInstanceOf(payload.Object_Vector);
  //         done();
  //       } catch (e) {
  //         done(e);
  //       }
  ...
  //     channel.on("data", (message) => {
  //       try {
  //         expect(message).toBeInstanceOf(payload.Object_StreamVector);
  //         if (message.hasStatus()) {
  //           const status = message.getStatus();
  //           if (status) {
  //             expect(status.getCode()).toEqual(0);
  ...
  //       try {
  //         expect(err).toBeFalsy();
  //         expect(resp).toBeInstanceOf(payload.Search_Response);
  ...
  //       try {
  //         expect(err).toBeFalsy();
  //         expect(resp).toBeInstanceOf(payload.Search_Responses);
  ...
  //     channel.on("data", (message) => {
  //       try {
  //         expect(message).toBeInstanceOf(payload.Search_StreamResponse);
  //         if (message.hasStatus()) {
  //           const status = message.getStatus();
  //           if (status) {
  //             expect(status.getCode()).toEqual(0);
